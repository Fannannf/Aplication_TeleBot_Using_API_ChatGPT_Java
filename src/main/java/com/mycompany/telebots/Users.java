...
import static com.mycompany.telebots.command.comm;
import static com.mycompany.telebots.command.id1;
import static com.mycompany.telebots.command.jawab;
...
public class Users extends javax.swing.JFrame {
    ...
    private void updateMessageToDatabase(String id,String username,String password) {
    ...
    private void saveMessageToDatabase(String username,String password) {
        try (Connection connection = DriverManager.getConnection(DB_URL, DB_USERNAME, DB_PASSWORD)) {
            try {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String id1 = id.getText();
          if(edit == true){
              updateMessageToDatabase(id1,username1,password1);
          }else{
              saveMessageToDatabase(username1,password1);
          }
        baca_tabel();
        kosong();
